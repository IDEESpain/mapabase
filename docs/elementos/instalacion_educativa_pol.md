## instalacion_educativa_pol
<br />

El elemento «instalacion_educativa_pol» incluye los objetos geográficos superficiales que definen los perímetros de las instalaciones educativas. Los datos pueden provenir de la información geográfica que produce el [*Instituto Geográfico Nacional (IGN)*](https://www.ign.es) y distribuye el [*Centro Nacional de Información Geográfica (CNIG)*](https://www.cnig.es), así como de la información geográfica de referencia o temática editada por las Comunidades Autónomas u otras administraciones públicas con competencias cartográficas.
...
|---|---|---|---|
|`clase`|string|instalacion_educativa|Clase de objeto|
