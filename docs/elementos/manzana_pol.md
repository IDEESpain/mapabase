...
El elemento «manzana_pol» está compuesto por los objetos geográficos poligonales que definen las manzanas urbanas. La información puede proceder del [*Instituto Geográfico Nacional (IGN)*](https://www.ign.es)  así como de la información geográfica de referencia producida por las Comunidades Autónomas u otras administraciones públicas con competencias cartográficas.  
...
|---|---|---|---|
|`clase`|string|manzana|Clase de objeto|
