...
El elemento «altimetria_pto» incluye la información puntual relativa a puntos acotados sobre el terreno. Los datos pueden provenir de la *Base Topográfica Nacional 1:25.000 (BTN25)* que edita el [*Instituto Geográfico Nacional (IGN)*](https://www.ign.es) y distribuye el [*Centro Nacional de Información Geográfica (CNIG)*](https://www.cnig.es), así como de la información topográfica de referencia producida por las Comunidades Autónomas u otras administraciones públicas con competencias cartográficas.
...
|`clase`|string|punto_acotado|Clase de objeto|
